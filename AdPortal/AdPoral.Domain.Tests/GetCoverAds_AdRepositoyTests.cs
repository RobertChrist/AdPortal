namespace AdPortal.Domain.Tests
{
    ...
    [TestClass]
    public class GetCoverAds_AdRepositoyTests
    {
        ...
        [TestMethod]
        public void GetCoverAds_SortsDescending()
        {
            var target = new AdRepository(_mockDataService);

            var result = target.GetCoverAds(_startDate, _endDate, "AdId", false, 9000, 0);
        ...
        [TestMethod]
        public void GetCoverAds_SortsNestedAscending()
        {
            var target = new AdRepository(_mockDataService);

            var result = target.GetCoverAds(_startDate, _endDate, "Brand.BrandId", true, 9000, 0);
