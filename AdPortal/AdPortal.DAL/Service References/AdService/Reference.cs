...
namespace AdPortal.DAL.AdService {
    ...
    public partial class Ad : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private AdPortal.DAL.AdService.Brand BrandField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public AdPortal.DAL.AdService.Brand Brand {
            get {
    ...
    public interface IAdDataService {
        ...
        AdPortal.DAL.AdService.Ad[] GetAdDataByDateRange(System.DateTime startDate, System.DateTime endDate);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAdDataService/GetAdDataByDateRange", ReplyAction="http://tempuri.org/IAdDataService/GetAdDataByDateRangeResponse")]
        System.Threading.Tasks.Task<AdPortal.DAL.AdService.Ad[]> GetAdDataByDateRangeAsync(System.DateTime startDate, System.DateTime endDate);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAdDataServiceChannel : AdPortal.DAL.AdService.IAdDataService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AdDataServiceClient : System.ServiceModel.ClientBase<AdPortal.DAL.AdService.IAdDataService>, AdPortal.DAL.AdService.IAdDataService {
        ...
        public AdPortal.DAL.AdService.Ad[] GetAdDataByDateRange(System.DateTime startDate, System.DateTime endDate) {
            return base.Channel.GetAdDataByDateRange(startDate, endDate);
        }
        
        public System.Threading.Tasks.Task<AdPortal.DAL.AdService.Ad[]> GetAdDataByDateRangeAsync(System.DateTime startDate, System.DateTime endDate) {
